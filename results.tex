...
(Listing~\ref{lst:androidManifest}). \kn{Is this the only app where the manifest was changed. If yes, I am not sure we can make broad claims about manifest being a serious place of vulnerabilities.} Moreover, after decompiling
