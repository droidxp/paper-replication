...
of the DroidFax static analysis component is statistically significant to identify
malwares in our experiment. To this end, we build a logistic regression model
in the form $Malware \sim Tool + StaticAnalysis + Repetition$. Table~\ref{tab:log-reg1}
shows the results of the logistic regression analysis, highlighting the
Humanoid has a negative and significant impact on malware identification and
the use of DroidFax static analysis has a positive and significant
