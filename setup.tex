...
\begin{enumerate}[(RQ1)]
 ...
 \item What is the effective performance of each test generation tool\kn{Should we use the term sandboxes instead of test generation tools? Test generation is just part of sandboxes right?}, in terms of the number of detected malware, when we
...
\kn{Isnt DroidXP a contribution of our approach? If yes, we should start more confidently than saying we "used" it. We should introduce it as a contribution as such.}
