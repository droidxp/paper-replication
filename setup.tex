...
answer RQ1 and RQ2. We also use \emph{Logistic Regression} to understand
the relevance of the features (tool, repetition, DroidFax static analysis
component) to predict the malware identification. 
