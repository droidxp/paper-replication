...
{\color{blue}{\bf Answer:} We agree that taint analysis explanation was very briefly. We reviewed our Background and related works Section, to better explain taint analysis from paragraph 7. We explained better the concept of ``source'' and ``sink'', and present how the analysis identifies sensitive information leakage, detecting taint flow between “source” and “sink”. To improve understanding, we also present a simple Listing (Listing 1), that present a simple data leakage example through data flows within source code Java. }
